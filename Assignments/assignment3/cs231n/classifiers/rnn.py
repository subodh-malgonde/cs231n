...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    ...
    # compute the initial hidden layer Nxhidden_dim
    h0 = features.dot(W_proj) + b_proj

    # convert word indices to word vectors Nx(T-1)xW
  ...
  def sample(self, features, max_length=30):
    ...
    prev_h_ = features.dot(W_proj) + b_proj
    ...
    for i in xrange(N):
      ...
      for j in xrange(max_length):
        ...
        prev_h = h
        if previous_word_index == self._end:
          break
